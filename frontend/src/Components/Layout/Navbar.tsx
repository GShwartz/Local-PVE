...
const Navbar = ({ username, onLogout, alertHistory, markAsRead, markAllAsRead, sidebarOpen = true, onToggleSidebar }: NavbarProps) => {
  ...
  const hasUnreadError = alerts.some(a => !a.read && a.type === 'error');
        ...
        <div className={styles['navbar-right']}>
          ...
          >
            <div className="relative">
              ...
              {unreadCount > 0 && (
                <span className={`absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full ${hasUnreadError ? 'bg-red-500' : 'bg-blue-500'} text-[10px] font-bold text-white ring-1 ring-white`}>
