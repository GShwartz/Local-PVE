      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <input
              ...
              className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 group-hover:border-gray-300"
            />
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <select
              ...
              className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-gray-900 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 group-hover:border-gray-300 appearance-none"
            >
              {nicModels.map((m) => (
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm font-semibold text-gray-700">
            ...
            VLAN Tag <span className="text-xs font-normal text-gray-500">(Optional)</span>
          </label>
          <div className="relative group">
            <input
              type="number"
              ...
              placeholder="e.g., 100"
              className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 group-hover:border-gray-300"
            />
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label htmlFor="firewall" className="text-sm font-medium text-gray-700 cursor-pointer">
                  Enable Firewall
                </label>
                <p className="text-xs text-gray-500">Protect this interface</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg border border-orange-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label htmlFor="linkDown" className="text-sm font-medium text-gray-700 cursor-pointer">
                  Disconnect Interface
                </label>
                <p className="text-xs text-gray-500">Set link status to down</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
        ...
        {/* Action buttons */}
        <div className="flex gap-2 justify-start pt-4 border-t border-gray-200">
          <button
            onClick={onClose}
            className="px-3 py-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg font-medium transition-colors duration-200"
          >
            Cancel
          </button>
          <button
